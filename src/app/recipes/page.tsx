...
export default function Recipes() {
  return (
    ...
    <div className="h-20 bg-secondary px-8 content-center">
      <h1 className='text-3xl text-center md:text-left font-semibold leading-relaxed'><RecipesIcon filled duotone className="w-8 h-8 mr-4 inline-block"/>Recipes</h1>
    </div>
